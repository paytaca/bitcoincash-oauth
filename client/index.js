...
class BitcoinCashOAuthClient {
   ...
   * @param {string} domain - Domain/host (optional, defaults to window.location.host or 'oauth')
   * @returns {string}
   */
   ...
   * @param {string} message - The message to sign (protocol|domain|userId|timestamp)
